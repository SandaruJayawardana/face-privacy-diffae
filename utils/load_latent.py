...
FILE_LOCATION = "/home/sjay9734/diff_encoder/face_privacy/face-privacy-diffae" # os.getcwd()
...
def pre_process_celebA(latent_file_name = "celebA_latents/latent.npy", detail_file = "celebA_latents/indexes", 
                       attr_list_file = "datasets/celeba_anno/list_attr_celeba.txt", TRAINING_AMOUNT = 0.7):
